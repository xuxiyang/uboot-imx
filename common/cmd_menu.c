...
static menu_info_st main_menu_info[]={
		...
		{'3',"boot from nfs","run nfs_root;run boot_nfs",NULL,NULL,0},
//		{'3',"boot from nfs","run nfs_root;setenv bootcmd run 'netboot'",NULL,NULL,0},		
...
/************* sd menu info *************/
static menu_info_st sd_menu_info[]={
		{'1',"sd update u-boot",NULL,&sdcard_update,NULL,0},
		{'2',"sd update kernel",NULL,&sd_update_kernel,NULL,0},
		{'3',"sd update dtb","fatcp mmc 0:1 imx6q-sabresd.dtb mmc 2:1 imx6q-sabresd.dtb",NULL,NULL,0},
		{'4',"sd update logo","fatcp mmc 0:1 logo.bmp mmc 2:1 logo.bmp",NULL,NULL,0},		
		{'5',"sd update system","fatcp mmc 0:1 rootfs.tgz mmc 2:1 rootfs.tgz",NULL,NULL,0},		
		{'6',"sd Onekey update","fatcp mmc 0:1 zImage mmc 2:1 zImage",NULL,NULL,0},
		{'q',"Return main menu:",NULL,NULL,NULL,0},
};
/************* net menu info *************/
static menu_info_st net_menu_info[]={
		{'1',"tftp update u-boot",NULL,NULL,NULL,0},
		{'2',"tftp update kernel",NULL,&tftp_update_kernel,NULL,0},
		{'3',"tftp update dtb","run tftp_loadfdt",NULL,NULL,0},			
		{'4',"tftp update logo","run tftp_loadlogo",NULL,NULL,0},
		{'5',"tftp update system",NULL,NULL,NULL,0},
		{'6',"OneKey update",NULL,&tftp_update_onekey,NULL,0},
...
static menu_info_st lvds_display_para_menu_info[]={
		{'1',"1366*768",NULL,&do_set_lvds_para_1366768,NULL,0},		
		{'s',"save setting","saveenv",NULL,NULL,0},		
		{'q',"quit",NULL,NULL,NULL,0},		
};
//++++++++++++++++++++++++++++++++++++          默认启动参数           ++++++++++++++++++++++++++++++++//
/************* default boot info *************/
static menu_info_st media_boot_menu_info[]={
		{'1',"android used emmc","setenv bootcmd 'run boot_android';setenv image 'boot.img'",NULL,NULL,0},		
		{'2',"linux used emmc","setenv bootcmd 'run boot_linux';setenv image 'zImage'",NULL,NULL,0},		
		{'3',"andorid used tftp & nfs","run nfs_root",NULL,NULL,0}, 	
		{'s',"save setting","saveenv",NULL,NULL,0},		
		{'q',"quit",NULL,NULL,NULL,0},		
};
//++++++++++++++++++++++++++++++++++++          内核参数           ++++++++++++++++++++++++++++++++//
